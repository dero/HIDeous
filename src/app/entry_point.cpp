...
#include "ui/components/device_list.h"
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    SettingsManager::getInstance().startWatching([hwnd]() {
        // We define WM_SETTINGS_CHANGED in ui/gui.h usually, but here we need it.
        // It is defined as WM_APP + 2 in main_window.h? No, logic was in gui.h.
        // I need to define it or include it.
        // I'll add it to main_window.h? or gui_types.h?
        // It's a message, so gui_types.h or main_window.h is fine.
